    ...
    >
      <g id="XMLID_1337_">
        <g id="XMLID_1338_">
          <g id="XMLID_1339_">
            <path
              id="XMLID_1340_"
              style="fill:#F3D8B6;"
              d="M260.026,237.405c-18.667-6.681-61.458-11.736-61.458-81.376h-29.23h-5.002
          ...
          <path
            id="XMLID_1341_"
            style="fill:#EEC8A2;"
            d="M198.568,156.03h-29.23h-2.376v135.509c1.499,0.462,2.376,0.642,2.376,0.642
        ...
        <g id="XMLID_1342_">
          <g id="XMLID_1343_">
            <path
              id="XMLID_1344_"
              style="fill:#F3DBC4;"
              d="M166.839,178.782c-27.454,0-48.409-23.119-57.799-40.456
          ...
          <path
            id="XMLID_1345_"
            style="fill:#EDCEAE;"
            d="M220.298,41.429c-19.134-25.966-51.172-24.012-53.335-23.848v161.197
        ...
        <g id="XMLID_1346_">
          <g id="XMLID_1347_">
            <path
              id="XMLID_52_"
              style="fill:#682234;"
              d="M201.509,25.918c0,0-24.427-32.813-39.707-24.598
          ...
          <path
            id="XMLID_1348_"
            style="fill:#581A2B;"
            d="M241.888,41.281C230.026,6.439,201.51,25.919,201.51,25.919
        ...
        <g id="XMLID_1349_">
          <g id="XMLID_1350_">
            <path
              id="XMLID_1353_"
              style="fill:#66A299;"
              d="M286.819,292.867l-0.125,40.681H46.731l0.125-40.681
          ...
          <path
            id="XMLID_1356_"
            style="fill:#5A9291;"
            d="M246.105,221.954c-6.043-3.641-20.69-6.429-27.844-8.195
        ...
        <g id="XMLID_1358_">
          <g id="XMLID_1359_">
            <path
              id="XMLID_1360_"
              style="fill:#A7B8D4;"
              d="M208.832,99.567h-27.689c-1.185,0-2.356,0.243-3.431,0.713l-10.874,3.873
          ...
          <path
            id="XMLID_1361_"
            style="fill:#8AA4C2;"
            d="M208.832,99.567h-27.689c-1.185,0-2.356,0.243-3.431,0.713l-10.749,3.829v10.544
        ...
        <g id="XMLID_1362_">
          <ellipse
            id="XMLID_33_"
            transform="matrix(0.3543 -0.9351 0.9351 0.3543 44.0056 285.8713)"
            style="fill:#EDCEAE;"
            cx="229.011"
            cy="111.07"
            rx="17.187"
          ...
          <ellipse
            id="XMLID_32_"
            transform="matrix(0.3543 0.9351 -0.9351 0.3543 171.4488 -26.1479)"
            style="fill:#F3DBC4;"
            cx="104.659"
            cy="111.077"
            rx="17.187"
